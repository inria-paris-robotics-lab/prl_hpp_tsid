...
from prl_hpp.tools.utils import replace_path_to_absolute, compare_configurations
...
class Robot:
    ...
    def __init__(self, compositeName, robotName, robot_description_param_prefix, joint_state_topic):
        ...
        Parameters
        ----------
            compositeName (str): see Humanoid Path Planner documentation.
        ...
        self.hpp_robot = HppRobot(compositeName, robotName, urdfStringExplicit, srdfStringExplicit)
    ...
    def reset(self):
        """
        'Reset' the robot as if it was just created.

        Re-init the hpp_robot.
        """
        self.hpp_robot.__init__(self.compositeName, self.robotName, self.hpp_robot.urdfString, self.hpp_robot.srdfString)
